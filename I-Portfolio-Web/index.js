...
$("#number3").jQuerySimpleCounter({ end: 50, duration: 8000 });
...
$(document).ready(function () {
  ...
  Animation.prototype.setUpElements = function () {
    for (var i = 0; i < this.animationArray.length; i++) {
      ...
      $(this.animationArray[i])
        .find(".label3")
        .html("JAVA SCRIPT: " + percentage + "%");
      $(this.animationArray[i])
        .find(".label4")
        .html("JQUERY: " + percentage + "%");
      $(this.animationArray[i])
        .find(".label5")
        .html("BOOT STRAP: " + percentage + "%");
      $(this.animationArray[i])
        .find(".label6")
        .html("MEDIA QUERY: " + percentage + "%");
      $(this.animationArray[i])
        .find(".label7")
        .html("REACT JS: " + percentage + "%");
      $(this.animationArray[i])
        .find(".label8")
        .html("NODE JS: " + percentage + "%");
      $(this.animationArray[i])
        .find(".label9")
        .html("PHP: " + percentage + "%");
      $(this.animationArray[i])
      ...
      $(this.animationArray[i])
        .find(".label11")
        .html("ANGULAR JS: " + percentage + "%");
      $(this.animationArray[i])
        .find(".label12")
        .html("C LANG.: " + percentage + "%");
      $(this.animationArray[i])
        .find(".label13")
        .html("C+ LANG: " + percentage + "%");
      $(this.animationArray[i])
      ...
      $(this.animationArray[i])
        .find(".label15")
        .html("PYTHON: " + percentage + "%");
      $(this.animationArray[i])
        .find(".label16")
        .html("RUBY ON RAIL: " + percentage + "%");
    }
